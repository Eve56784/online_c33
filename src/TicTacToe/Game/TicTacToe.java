...
public class TicTacToe {
    ...
    public static void makeAIMove(char[][] gameTable, char symbol){
        int rowAI, columnAI;
        while(true){
            rowAI = getRandomNumbers().nextInt(2);
            columnAI = getRandomNumbers().nextInt(2);
    ...
    public static void makePlayerMove(char[][] gameTable, char symbol){
        ...
        while(true){
            ...
            if(rowPlayer>0 && rowPlayer <= 3 && columnPlayer >0 && columnPlayer <=3){
